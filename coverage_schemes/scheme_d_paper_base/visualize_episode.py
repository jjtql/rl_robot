...
def build_arg_parser():
    ...
    parser.add_argument("--policy", default="risk_aware", choices=["ppo", "random", "nearest", "oldest", "distance_age", "risk_aware", "dynamic_weighted", "horizon2", "horizon3", "deadline_horizon2", "deadline_rescue_horizon2", "aco_tsp", "planner_ensemble"])
