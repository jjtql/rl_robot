...
DEFAULT_CONFIG = {
    ...
    "urgency_scoring": False,
    "urgency_attention_sort": False,
    "urgency_observation_sort": False,
    "edf_route_scoring": False,
    "horizon_urgency_candidates": 0,
    "urgency_score_gain": 0.55,
    "urgency_travel_penalty_gain": 0.25,
    "use_curriculum": True,
    ...
    "full_session_spawn_steps": 0,
    "full_session_spawn_seconds": None,
    "full_session_drain_steps": 0,
    "full_session_drain_seconds": None,
    "full_session_end_on_clear": False,
    ...
    "residual_combine_mode": "add",
    "residual_guard": True,
    "residual_min_alignment": 0.15,
    ...
    "residual_pathbend_shield": False,
    "residual_pathbend_min_progress_ratio": 0.35,
    "residual_pathbend_guarded_progress_ratio": 0.50,
    "residual_pathbend_allow_backtrack_steps": 0.0,
    "residual_supervised_bc": False,
    "residual_bc_policy": "dynamic_weighted",
    "residual_bc_min_alignment": -1.0,
    "stagnation_recovery_steps": 180,
    "recurrent_reset_on_cover": True,
    "recurrent_reset_on_miss": True,
    "ppo_decision_interval": 1,
    "ppo_emergency_replan_age_ratio": 0.65,
    "device": "auto",
    "ppo_lr": 1e-4,
    "ppo_epochs": 4,
    "ppo_clip": 0.12,
