...
_V18_SLACK_EDF = _set_flag_values(
    _V16_CORRIDOR,
    (
        ("--bc-policy", "slack_horizon2"),
        ("--residual-base-policy", "slack_horizon2"),
        ("--residual-sparse-base-policy", "slack_horizon2"),
        ("--residual-dense-base-policy", "slack_horizon2"),
        ("--residual-bc-policy", "corridor_waypoint"),
        ("--residual-min-alignment", "0.18"),
        ("--residual-beta", "0.22"),
        ("--residual-beta-start", "0.03"),
        ("--residual-beta-end", "0.22"),
        ("--residual-sparse-beta-scale", "0.90"),
        ("--residual-lull-beta-scale", "1.00"),
        ("--residual-charging-beta-scale", "0.85"),
        ("--residual-dense-beta-scale", "0.28"),
        ("--residual-burst-beta-scale", "0.20"),
        ("--residual-emergency-beta-scale", "0.04"),
        ("--residual-emergency-age-ratio", "0.66"),
        ("--residual-pathbend-min-progress-ratio", "0.28"),
        ("--residual-pathbend-guarded-progress-ratio", "0.50"),
        ("--residual-pathbend-allow-backtrack-steps", "0.0"),
        ("--residual-bc-min-alignment", "0.15"),
        ("--bc-supervised-coef", "0.05"),
        ("--bc-supervised-min-coef", "0.005"),
        ("--bc-supervised-decay-steps", "420000"),
    ),
)
_V20_STICKY_SLA = _set_flag_values(
    _V16_CORRIDOR,
    (
        ("--bc-policy", "sticky_sla_ensemble"),
        ("--residual-base-policy", "sticky_sla_ensemble"),
        ("--residual-sparse-base-policy", "sticky_sla_ensemble"),
        ("--residual-dense-base-policy", "sticky_sla_ensemble"),
        ("--residual-bc-policy", "corridor_waypoint"),
        ("--residual-min-alignment", "0.25"),
        ("--residual-beta", "0.14"),
        ("--residual-beta-start", "0.02"),
        ("--residual-beta-end", "0.14"),
        ("--residual-sparse-beta-scale", "0.80"),
        ("--residual-lull-beta-scale", "0.90"),
        ("--residual-charging-beta-scale", "0.75"),
        ("--residual-dense-beta-scale", "0.20"),
        ("--residual-burst-beta-scale", "0.14"),
        ("--residual-emergency-beta-scale", "0.03"),
        ("--residual-emergency-age-ratio", "0.70"),
        ("--residual-pathbend-min-progress-ratio", "0.45"),
        ("--residual-pathbend-guarded-progress-ratio", "0.70"),
        ("--residual-pathbend-allow-backtrack-steps", "0.0"),
        ("--residual-bc-min-alignment", "0.25"),
        ("--bc-supervised-coef", "0.035"),
        ("--bc-supervised-min-coef", "0.0"),
        ("--bc-supervised-decay-steps", "280000"),
    ),
)
_V21_STICKY_SAFE = _set_flag_values(
    _drop_flags(
        _V20_STICKY_SLA,
        flags=("--residual-supervised-bc", "--residual-pathbend-shield"),
        value_flags=(
            "--residual-bc-policy",
            "--residual-bc-min-alignment",
            "--residual-pathbend-min-progress-ratio",
            "--residual-pathbend-guarded-progress-ratio",
            "--residual-pathbend-allow-backtrack-steps",
        ),
    ),
    (
        ("--residual-min-alignment", "0.35"),
        ("--residual-beta", "0.06"),
        ("--residual-beta-start", "0.0"),
        ("--residual-beta-end", "0.06"),
        ("--residual-sparse-beta-scale", "0.60"),
        ("--residual-lull-beta-scale", "0.70"),
        ("--residual-charging-beta-scale", "0.55"),
        ("--residual-dense-beta-scale", "0.12"),
        ("--residual-burst-beta-scale", "0.08"),
        ("--residual-emergency-beta-scale", "0.0"),
        ("--residual-emergency-age-ratio", "0.62"),
