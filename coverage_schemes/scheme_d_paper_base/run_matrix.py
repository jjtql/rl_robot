...
def build_arg_parser():
    ...
    parser.add_argument("--policies", default="random,nearest,oldest,distance_age,risk_aware,dynamic_weighted,horizon2,horizon3,deadline_horizon2,deadline_rescue_horizon2,corridor_waypoint,aco_tsp,planner_ensemble,ppo")
